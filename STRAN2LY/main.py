...
#encoder-decoder
CONFIG_FILE_PATH = './checkpoints/frozen/model_config.json'#'./checkpoints/current_config.json'
GPU_INDEX = 3
...
CHECKPOINTS_PATH = "./checkpoints/frozen" # Path to save the epochs and average losses
LEARNING_RATE = 5e-5
...
VALIDATION_OUTPUT = "./evaluator_output/frozen" # Path to save the output (bbox and class for each picture)
...
EPOCHS_VALIDATION = list(range(100))#list(range(0,EPOCHS,3)) # Number of the epoch to validate
