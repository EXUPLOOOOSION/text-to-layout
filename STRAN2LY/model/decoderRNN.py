...
class DecoderRNN(nn.Module):
    ...
    def __init__(self, vocab_size, hidden_size, is_training, bbox_dimension=128, dropout_p=0.2, use_attention=False, bidirectional=False, xy_distribution_size=16, temperature=0.4):

        super(DecoderRNN, self).__init__()
        self.hidden_size = hidden_size
        self.bidirectional = bidirectional
        self.output_size = vocab_size #number of class (words) + 4 (<pad>, <sos>, <eos>, <unk>)
