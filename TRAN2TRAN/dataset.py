...
class CocoDataset(Dataset):
    ...
    def __init__(self, dataset_path, instan_path, white_list=None, normalize=True, vocab=None, image_size=(256, 256), uq_cap=False, max_objects=10):
        ...
        total = 0
        # you need to make a copy because if you delete an item while iterating through a list it skips some items.
        #Example: if you have ['a','b','c'] and you do a for loop through it and remove 'a' in the first iteration, it will only process 'a' and 'c'. It will skip 'b'.
