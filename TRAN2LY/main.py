...
CHECKPOINTS_PATH = "./checkpoints/unfrozen_max" # Path to save the epochs and average losses
LEARNING_RATE = 5e-5
...
VALIDATION_OUTPUT = "./evaluator_output/unfrozen_max" # Path to save the output (bbox and class for each picture)
