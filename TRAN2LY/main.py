...
CHECKPOINTS_PATH = "./checkpoints/unfrozen_max_attn" # Path to save the epochs and average losses
LEARNING_RATE = 5e-5
...
VALIDATION_OUTPUT = "./evaluator_output/unfrozen_max_attn" # Path to save the output (bbox and class for each picture)
...
EPOCHS_VALIDATION = [99]#list(range(STARTING_EPOCH,STARTING_EPOCH+EPOCHS))#list(range(0,EPOCHS,3)) # Number of the epoch to validate
